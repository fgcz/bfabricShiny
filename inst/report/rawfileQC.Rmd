...
```{r}
QC <- bfabricShiny:::.calc.master.scan(rawfileQC.parameter$data.QC)
```
...
out <- tryCatch({
  ...
  message("This plot is not available for this meassurement.")
})
```
...
[3] https://fgcz-bfabric.uzh.ch/bfabric/userlab/show-resource.html?resourceId=`r rawfileQC.parameter$resourceid`
