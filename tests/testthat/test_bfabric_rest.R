...
test_that("test read", {
  ...
  # These variables need to be defined in the .Rprofile file.
  # Ensure you have the REST service running at bfabricposturl.
  ...
  testthat::expect_equal(substr(bfabricposturl, nchar(bfabricposturl), nchar(bfabricposturl)), "/")
  rv <- httr::POST(paste0(bfabricposturl, '/read'),
  ...
  resources <- bfabricShiny:::.getResources(login,
                                            ...
                                            posturl = bfabricposturl,
                                            workunitid = 187604,
                                            createdbefore = "2020-02-10 16:01:00") |>
  ...
  expect_equal(
    ...
    1282795, 1279978, 1279940, 1279828), resources
  )
  ...
  expect_true("202584 - MaxQuant_Abird_2ng" %in%
              bfabricShiny:::.getWorkunits(login,
                                           ...
                                           posturl = bfabricposturl,
                                           containerid = 3000,
                                           createdbefore = "2019-10-26 15:26:49"))

  expect_equal(list(), bfabricShiny:::.getWorkunits(login,
                                           webservicepassword,
                                           posturl = bfabricposturl,
                                           containerid = 3001,
                                           createdbefore = "2019-10-26 15:26:49"))
